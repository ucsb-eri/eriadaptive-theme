        ...
        <?php if ($site_logo || $site_name || $site_slogan): ?>
          ...
          <div id="branding" class="branding-elements clearfix">
            ...
            <?php if ($site_logo): ?>
              <div id="logo">
                <map name="logomap">
                  <area shape="rect" coords="0,0,960,200" href="/" alt="Home" />
                </map>
                <img usemap="logomap" id='logo_mapped_image' class="site-logo image-style-none" src="http://www-dev.eri.ucsb.edu/sites/default/files/ERI_Banner_Futura_Std_Blue_Final.jpg" alt="Earth Research Institute" />
               </div>
            <?php endif; ?>
            ...
            <<?php print $tag; ?> id="main-content" role="main">
              ...
              <?php if ($title || $primary_local_tasks || $secondary_local_tasks || $action_links = render($action_links)): ?>
                <header id="main-content-header" class="clearfix">
                  ...
                  <?php if ($title): ?>
                  <h1 id="page-title"><?php print $title . " "; if(isset($node->field_bio_last_name['und'][0]['safe_value'])) { print $node->field_bio_last_name['und'][0]['safe_value']; } ?></h1>
                  <?php endif; ?>

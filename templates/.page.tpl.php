          ...
          <div id="branding" class="branding-elements clearfix">
            ...
            <?php if ($site_logo): ?>
              <div id="logo">
                ...
                <img usemap="#logomap" id='logo_mapped_image' class="site-logo image-style-none" src="http://www.eri.ucsb.edu/sites/default/files/ERI_Banner_Futura_Std_Blue_Final.jpg" alt="Earth Research Institute" />
               </div>
            <?php endif; ?>
